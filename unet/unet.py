...
class DoubleConv(nn.Module):
    """
    2 layers of Convolution > BatchNorm > ReLU
    """
    def __init__(self, in_channels, out_channels, mid_channels=None):
        ...
        self.double_conv = nn.Sequential(
            ...
            nn.BatchNorm2d(num_features=mid_channels), nn.ReLU(inplace=True),
...
if __name__ == "__main__":
    # # Test Up
    # input = torch.randn(size=(2, 64, 50, 50))
    # print("input", input.shape)
    #
    # x4 = Down(64, 100)(input)
    # print("x4", x4.shape)
    # x5 = Down(100, 200)(x4)
    # print("x5", x5.shape)
    # output = Up(200+100, 64)(x5, x4)
    # print("output", output.shape)

    # Test UNet
    mdl = UNet(n_channels=3, n_classes=10)
